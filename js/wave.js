...
var Wave = (function () {
  ...
  return {
    ...
    update: function (sources, dt) {
      clock += dt;
      gusts.length = 0;
      //  v9.3: no gusts while the greeting is speaking. A visitor settling
      //  the headset on their head moves their hands fast, and without
      //  this the flock would be blown around before they have been told
      //  anything.
      if (typeof Welcome !== 'undefined' && Welcome.locked()) { return 0; }
