...
var SFX = (function () {
  ...
  //  All five music/SFX clips that started as WAV are re-encoded to MP3 here
  //  (see README.md "Load lag" section) -- same audio, ~70% less to download.
  //  butterfly2/pickup/swoosh were already compressed and are untouched.
  var CLIPS = {
